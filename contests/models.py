...
class FNTest(CRUDEntry):
    HANDLER_CHOICES = (
        ...
        ('fsme.init', "файловый менеджер - экзамен: тривиальный"),
        ('fsme.spec', "файловый менеджер - экзамен: специальный"),
        ('meme.init', "менеджер памяти - экзамен: тривиальный"),
        ('meme.spec', "менеджер памяти - экзамен: специальный"),
